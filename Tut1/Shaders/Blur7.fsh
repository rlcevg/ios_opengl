...
//        color += texture2D(textureSource, vec2(texCoord.x + 3.0 * scale, texCoord.y)) * 0.015625;
        ...
        color += texture2D(textureSource, vec2(texCoord.x + -2.0 * scale, texCoord.y));
        color += texture2D(textureSource, vec2(texCoord.x + -1.0 * scale, texCoord.y));
        color += texture2D(textureSource, vec2(texCoord.x + 1.0 * scale, texCoord.y));
        color += texture2D(textureSource, vec2(texCoord.x + 2.0 * scale, texCoord.y));
        color *= 0.25;
    } else {
...
//        color += texture2D(textureSource, vec2(texCoord.x, texCoord.y + 3.0 * scale)) * 0.015625;
        ...
        color += texture2D(textureSource, vec2(texCoord.x, texCoord.y + -2.0 * scale));
        color += texture2D(textureSource, vec2(texCoord.x, texCoord.y + -1.0 * scale));
        color += texture2D(textureSource, vec2(texCoord.x, texCoord.y + 1.0 * scale));
        color += texture2D(textureSource, vec2(texCoord.x, texCoord.y + 2.0 * scale));
        color *= 0.25;
    }
